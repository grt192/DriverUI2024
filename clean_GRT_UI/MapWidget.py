...
class MapWidget(QWidget):
    def __init__(self, alliance, parent=None):
        ...
        self.mapPixmap = QPixmap(f"{os.path.dirname(__file__)}/images/field24.png").scaled(600, 300)
        self.robotPixmap = QPixmap(f"{os.path.dirname(__file__)}/images/grt23robot.png")
        self.crosshairPixmap = QPixmap(f"{os.path.dirname(__file__)}/images/crosshair.png")
