...
class SwerveWheelWidget(QWidget):
    ...
    def __init__(self):
        ...
        self.robot.setGeometry(QtCore.QRect(0,0, 500 * self.scale, 500 * self.scale))
        # self.networktableHelper = networktableHelper(self)
        
        self.nt_manager = NetworkTableManager(table_name="Testing")
        self.nt_manager.new_value_available.connect(self.update_vals)
    ...
    def refreshRobot(self):
        # print("R ", self.vel_rot_dict["module4vel"])
        ...
        self.robotWheel1.setPixmap(self.wheelPixmap.scaled(80 * self.scale, 80 * self.scale, aspectMode=QtCore.Qt.AspectRatioMode.KeepAspectRatio).transformed(QTransform().rotate(self.vel_rot_dict["module1rot"])))
        self.robotWheel2.setPixmap(self.wheelPixmap.scaled(80 * self.scale, 80 * self.scale, aspectMode=QtCore.Qt.AspectRatioMode.KeepAspectRatio).transformed(QTransform().rotate(self.vel_rot_dict["module2rot"])))
        self.robotWheel3.setPixmap(self.wheelPixmap.scaled(80 * self.scale, 80 * self.scale, aspectMode=QtCore.Qt.AspectRatioMode.KeepAspectRatio).transformed(QTransform().rotate(self.vel_rot_dict["module3rot"])))
        self.robotWheel4.setPixmap(self.wheelPixmap.scaled(80 * self.scale, 80 * self.scale, aspectMode=QtCore.Qt.AspectRatioMode.KeepAspectRatio).transformed(QTransform().rotate(self.vel_rot_dict["module4rot"])))
        
        scaledSize1 = 80*self.vel_rot_dict["module1vel"] * self.scale
        scaledSize2 = 80*self.vel_rot_dict["module2vel"] * self.scale
        scaledSize3 = 80*self.vel_rot_dict["module3vel"] * self.scale
        scaledSize4 = 80*self.vel_rot_dict["module4vel"] * self.scale
        ...
        self.arrow1.setPixmap(scaledArrow4.transformed(QTransform().rotate(self.vel_rot_dict["module1rot"])))
        self.arrow2.setPixmap(scaledArrow4.transformed(QTransform().rotate(self.vel_rot_dict["module2rot"])))
        self.arrow3.setPixmap(scaledArrow4.transformed(QTransform().rotate(self.vel_rot_dict["module3rot"])))
        self.arrow4.setPixmap(scaledArrow4.transformed(QTransform().rotate(self.vel_rot_dict["module4rot"])))
        halfScaledSize1 = scaledSize1/2
        halfScaledSize2 = scaledSize2/2
        halfScaledSize3 = scaledSize3/2
        halfScaledSize4 = scaledSize4/2
        self.arrow1.move(int(self.x0 * self.scale - halfScaledSize1), int(self.y0 - halfScaledSize1))
        self.arrow2.move(int(self.x1 - halfScaledSize2), int(self.y1 - halfScaledSize2))
        self.arrow3.move(int(self.x2 - halfScaledSize3), int(self.y2 - halfScaledSize3))
        self.arrow4.move(int(self.x3 - halfScaledSize4), int(self.y3 - halfScaledSize4))
    ...
    def update_vals(self, key, val):
        
        if "vel" in key:
            self.vel_rot_dict[key] = val + 1
        elif "rot" in key:
            self.vel_rot_dict[key] = val*180/3.14
        else:
            self.vel_rot_dict[key] = val
        # print("U ", self.vel_rot_dict["module4vel"])
